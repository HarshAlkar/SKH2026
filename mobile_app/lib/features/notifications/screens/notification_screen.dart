...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  void _handleNotificationTap(NotificationModel notification) {
    if (notification.severityLevel == SeverityLevel.critical) {
      Navigator.pushNamed(context, AppRoutes.emergencyReferral, arguments: notification);
    } else {
      Navigator.pushNamed(context, '/asha/patient-details', arguments: notification.patientName);
    }
  }
